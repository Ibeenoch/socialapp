...
home.forEach((item) => {
  ...
  return (
    <div style={{display: 'flex', justifyContent: 'space-between',background: 'grey', border: '1rem solid blue', alignItems: 'center' , padding: '0rem 1rem', height: 'max-content', width: '100℅'}}>
