...
const Comment = () => {
  ...
  return (
    <div style={{ width: '100℅', height: '90vh', margin: '1rem 0.5rem', borderRadius: '1.2rem'}}>
        <Box sx={{ width: '100%', height:'90vh', background: 'white', borderRadius: '1.2rem', boxShadow: '0 0 1rem gray'}} >
